...
#Voter.spawn("g", voter_registry, cand_registry, StupidSort.generate("Bernie"))
#Voter.spawn("h", voter_registry, cand_registry, StupidSort.generate("Bernie"))
#Voter.spawn("i", voter_registry, cand_registry, StupidSort.generate("Bernie"))
